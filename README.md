...
| Asset Type              | Asset Name                                                 |
| ----------------------- | ---------------------------------------------------------- |
| Static Mesh (01)        | Rock_S_01                                                  |
| Static Mesh (02)        | Rock_S_02                                                  |
| Static Mesh (03)        | Rock_S_03                                                  |
| Material                | Rock_M                                                     |
...
Note: For JPL we'll be using suffixes for the majority of files
